<template>
  <v-btn
    :to="{ name: 'view-customer-bills', params: { customerId: customerId} }"
    variant="outlined"
    color="primary"
    size="large"
  ...
  import { getBill } from "@/bills/bill-service";
  import { useQuery } from "@tanstack/vue-query";
  import { useRoute } from "vue-router";
  import BillDetails from "@/bills/components/BillDetails.vue"
  import {
    mdiArrowRight
  } from '@mdi/js'
  
  const route = useRoute();
  const id = Number(route.params.billId);
